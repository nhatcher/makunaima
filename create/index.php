...
function setup()
{
document.captureEvents(Event.MOUSEMOVE);//¿Es necesario?
...
<!--        <img src="images/universidad.png" alt="" class="dragme" /><br/>
        <img src="images/departamento.png" alt="" class="dragme"/><br/>-->
<script type="text/javascript">
repaint();
window.onload=setup();
//document.onmousedown=selectmouse;
